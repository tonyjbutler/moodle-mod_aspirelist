...
$string['authorsinconfig'] = 'Authors in config forms';
...
$string['configaspireurl'] = 'Enter the base URL of your Talis Aspire site (not an HTTPS alias).';
$string['configaspireurlhttpsalias'] = 'Enter the HTTPS alias URL of your Talis Aspire site (if you have one).';
$string['configauthorsinconfig'] = 'Should resource item descriptions in module configuration forms include the names of authors? By default only the item title and resource format are included, to save space on the form.';
$string['configcodecolumn'] = 'Optional. The name of the column in the custom table containing your Talis Aspire list codes';
$string['configcoderegex'] = 'Optional. If using the course ID number or short name as your code source, this is a regular expression (including delimiters) matching the Talis Aspire code part of it. If no regex is provided here it will be assumed that the field contains the Aspire code only.';

...
$string['cachedef_jsondata'] = 'Cached resource list/item data fetched from Talis Resource Lists API';
$string['cachedef_listdata'] = 'Cached resource list data fetched from Talis Aspire site';
...
$string['personasettings_desc'] = 'If you want the plugin to make use of the new Talis Reading Lists API you must obtain a Talis Persona client ID and secret from support@talisaspire.com and enter them here (as well as your tenant code in the API settings). This is now the recommended method of retrieving list data (and will soon become the only supported method).';
...
$string['rlapinotconfigured'] = 'Talis Reading Lists API not fully configured. Falling back on screen scraping method to fetch list data.';
$string['rlapisettings'] = 'Talis Reading Lists API settings';
$string['rlapiurl'] = 'API URL';
$string['rlapiurl_desc'] = 'Unless Talis has provided you with a different API URL, the default value should work fine.';
$string['rlapiversion'] = 'API version';
$string['rlapiversion_desc'] = 'The current API version (leave as the default value unless advised otherwise).';
$string['school'] = 'School';
$string['selectresources'] = 'Select resources from "{$a}"';
$string['settingmisconfigured'] = 'Aspirelist admin setting "{$a}" is empty or misconfigured.';
$string['showhide'] = 'Show/hide resource list';
$string['subject'] = 'Subject';
$string['tenantcode'] = 'Tenant code';
$string['tenantcode_desc'] = 'Your tenant code is usually a shortened form of your institution name (e.g. <em>lancaster</em>). If in doubt ask Talis support.';
$string['unit'] = 'Unit';

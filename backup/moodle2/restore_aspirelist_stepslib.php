...
/**
 * Define all the restore steps that will be used by the restore_aspirelist_activity_task
 */

/**
 * Structure step to restore one aspirelist activity
 */
class restore_aspirelist_activity_structure_step extends restore_activity_structure_step {
    ...
    protected function process_aspirelist($data) {
        global $DB;
